jQuery(document).ready(function($) {
    ...
    function activateTab(tab) {
        ...
        // Add 'nav-tab-active' class to the tab corresponding to the URL parameter
    ...
    // If a 'tab' parameter exists in the URL, activate that tab, else activate the default tab
    if (tab) {
        activateTab(tab);
    } else {
    ...
    // Add event listener to the field type select element
